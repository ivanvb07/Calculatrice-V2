public class Calculatrice { // initialisation de la classe test
	public static void main(String[] args) { // méthode main
		...
		} catch (IllegalArgumentException e) { // si une erreur/exception est détectée par le bloc try, alors catch l'attrape et exécute les instructions de son propre bloc
